...
const models = [ stocks, commandStats, bankAccounts, hookAKeys, botValues, fiveEMonsters, fiveESpells, fiveEItems ]

module.exports = {sequelize, stocks, commandStats, bankAccounts, hookAKeys, botValues, fiveEMonsters, fiveEItems, fiveESpells, models };